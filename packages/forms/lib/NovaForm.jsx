...
class GrudrForm extends Component{
  ...
  submitForm(data) {
    ...
    // note: it follows the same logic as GrudrForm's getDocument method
    data = {
  ...
  componentWillUnmount() {
    ...
    // example : the closeCallback is a function that closes a modal by calling setState, this modal being the parent of this GrudrForm component
