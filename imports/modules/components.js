...
Grudr.registerComponent('Icon', require('../ui/components/common/Icon.jsx'));
Grudr.registerComponent('HeadTags', require('../ui/components/common/HeadTags.jsx'));


Grudr.registerComponent('Hello', require('../ui/Hello.jsx'));
